...
--登录
exports.LOGIN_NAME_PW_ERROR = 2000             -- 用户名或者密码错误
exports.LOGIN_TOKEN_ERROR = 2001             -- token错误
exports.LOGIN_IS_OFFLINE = 2002              --用户已经掉线 



--大厅 code 
exports.HALL_OFFLINE = 3001              --用户不在hall场景
exports.HALL_SEAT_ALREAY_IN_ANOTHER_ROOM = 3002     -- 已经在其他房间了
exports.HALL_CREATE_ROOM_FULL = 3002     -- 房间满，找不到空闲的房间
exports.HALL_CREATE_ROOM_NO_CARD = 3003     -- 房卡不够 
